...
<div class="card">
    ...
    <div class="card-content">
        <div class="content">
            <form class="form-horizontal" method="POST" action="{{ route('toutlespays.update', $toutlespay->id) }}">
                {{ csrf_field() }}
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input id="nom" type="text"   name="nom" value="{{ old('nom',$toutlespay->nom) }}" required>
                    </div>
                    @error('nom')
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input id="nb_habitant" type="numeric" name="nb_habitant" value="{{ old('duree',$toutlespay->nb_habitant) }}" >
                        @error('nb_habitant')
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input id="superficie" type="text"  name="superficie" value="{{ old('unite',$toutlespay->superficie) }}" >
                        @error('superficie')
